...
export const LoggedOutLayout = () => {
  ...
  return (
    <section>
      <div
        id="about"
        className="grid grid-cols-1 lg:grid-cols-12 gap-y-10 gap-x-5"
      >
        <div className="lg:col-span-5 flex items-center justify-center">
          <h1 className="max-w-[27.125rem] !leading-tight font-semibold text-black text-center lg:text-left text-[1.5625rem] md:text-[1.75rem]">
            {description}
          </h1>
        </div>
      ...
      <div
        id="services"
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-5 gap-y-10 pb-20 lg:pb-24"
      >
        ...
        <h2 className="col-span-full text-center text-xl md:text-[1.5625rem] text-black font-semibold">
          {subtitle}
        </h2>
        {features.map((feature, index) => (
          ...
          >
            ...
            <h3 className="text-xl text-green font-semibold">
              {feature.title}
            </h3>
            <p className="text-gray-dark leading-tight">
              {feature.description}
            </p>
          </div>
        ))}
